...
contract BikeChain {
    ...
    // function getAllBikeChain() public view returns (Renter memory) {
    //     return renters;
    // }
    ...
    function getRenter(address walletAddress) public isRenter(walletAddress) view returns(string memory firstName, string memory lastName, bool canRent, bool active,uint start) {
